...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurity(JwtUserDetailsService jwtUserDetailsService, JwtRequestFilter jwtRequestFilter, BCryptPasswordEncoder bCryptPasswordEncoder, JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint) {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                .authorizeRequests().antMatchers("/auth", "/registration", "/redirect/**").permitAll().
